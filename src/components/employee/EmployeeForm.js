...
const handleControlledInputChange = (event) => {
    ...
    // forms always provide values as strings. But we want to save the ids as numbers. This will cover location ids
...
if (locationId === 0 || employeeName === "") {
    window.alert("Please enter a name and location.");
} else {
